#!/home/cds-josh/anaconda3/envs/centerpoint/bin/python
import rospy
import ros_numpy
import numpy as np
import copy
...
if __name__ == "__main__":
    ...
    global proc
    # CenterPoint
    config_path = 'src/CenterPoint/configs/centerpoint/nusc_centerpoint_pp_02voxel_circle_nms_demo.py'
    model_path = 'src/CenterPoint/models/last.pth'
    print("config & model imported!")
    ...
    sub_lidar = rospy.Subscriber(
        sub_lidar_topic[-1], PointCloud2, rslidar_callback, queue_size=1, buff_size=2**24)
